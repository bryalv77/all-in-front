...
function ProductReviewViewItem(props) {
  ...
  const displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record.comment}</div>;
  };
...
ProductReviewViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
};

export default ProductReviewViewItem;
