...
const schema = yup.object().shape({
  ...
  songId: yupFilterSchemas.relationToOne(
    i18n('entities.playlistSong.fields.songId'),
  ),
  trackOrderRange: yupFilterSchemas.integerRange(
    i18n('entities.playlistSong.fields.trackOrderRange'),
  ),
});
...
export default PlaylistSongListFilter;
