...
function OperationForm(props) {
  ...
  const [initialValues] = useState(() => {
    ...
    return {
      ...
      valueDate: record.valueDate ? moment(record.valueDate, 'YYYY-MM-DD').toDate() : null,
      operationDate: record.operationDate ? moment(record.operationDate, 'YYYY-MM-DD').toDate() : null,
    ...
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="w-full sm:w-md md:w-md lg:w-md">
          ...
          placeholder={i18n('entities.operation.placeholders.fintonicId')}
          hint={i18n('entities.operation.hints.fintonicId')}
            required={false}
          autoFocus
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.description')}
          hint={i18n('entities.operation.hints.description')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.reference')}
          hint={i18n('entities.operation.hints.reference')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.note')}
        ...
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.userDescription')}
          hint={i18n('entities.operation.hints.userDescription')}
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.quantity')}
        ...
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.valueDate')}
          hint={i18n('entities.operation.hints.valueDate')}
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.operationDate')}
          hint={i18n('entities.operation.hints.operationDate')}
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.cleanNote')}
          hint={i18n('entities.operation.hints.cleanNote')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.cleanUserDescription')}
          hint={i18n('entities.operation.hints.cleanUserDescription')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.primaryDisplay')}
          hint={i18n('entities.operation.hints.primaryDisplay')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.secondaryDisplay')}
          hint={i18n('entities.operation.hints.secondaryDisplay')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.categoryId')}
          hint={i18n('entities.operation.hints.categoryId')}
            required={false}
        ...
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.bankId')}
        ...
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          placeholder={i18n('entities.operation.placeholders.userId')}
