...
function AvailabilityTimeslotViewToolbar(props) {
  const [
  ...
  const hasPermissionToEdit = useSelector(
    availabilityTimeslotSelectors.selectPermissionToEdit,
  );
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/availability-timeslot/${id}/edit`}>
          <button
...
export default AvailabilityTimeslotViewToolbar;
