...
function SubTasksListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    subTasksSelectors.selectPermissionToEdit,
  );
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.status
                      ? i18n(
                          `entities.subTasks.enumerators.status.${row.status}`,
                        )
                      : null}
                  </td>
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    <TasksListItem value={row.taskId} />
                  </td>
                  <td
...
export default SubTasksListTable;
