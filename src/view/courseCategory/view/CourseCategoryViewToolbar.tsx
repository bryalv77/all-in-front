...
function CourseCategoryViewToolbar(props) {
  ...
  const hasPermissionToEdit = useSelector(
    courseCategorySelectors.selectPermissionToEdit,
  );
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/course-category/${id}/edit`}>
          <button
...
export default CourseCategoryViewToolbar;
