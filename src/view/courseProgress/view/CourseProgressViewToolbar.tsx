...
function CourseProgressViewToolbar(props) {
  ...
  const hasPermissionToEdit = useSelector(
    courseProgressSelectors.selectPermissionToEdit,
  );
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/course-progress/${id}/edit`}>
          <button
...
export default CourseProgressViewToolbar;
