...
function ConversationParticipantListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    conversationParticipantSelectors.selectPermissionToEdit,
  );
                ...
                <tr key={row.id}>
                  ...
                  >
                    <Link
                      ...
                      to={`/conversation-participant/${row.id}`}
                    ...
                    {hasPermissionToEdit && (
                      <Link
                        className="inline-flex justify-center items-center w-9 h-9 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                        to={`/conversation-participant/${row.id}/edit`}
...
export default ConversationParticipantListTable;
