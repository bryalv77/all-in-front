...
import actions from '../../../modules/student/form/studentFormActions';
import selectors from '../../../modules/student/form/studentFormSelectors';
...
function StudentFormPage(props) {
  ...
  const title = isEditing
    ? i18n('entities.student.edit.title')
    : i18n('entities.student.new.title');
