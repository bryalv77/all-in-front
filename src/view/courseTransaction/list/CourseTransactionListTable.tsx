...
function CourseTransactionListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    courseTransactionSelectors.selectPermissionToEdit,
  );
                ...
                <tr key={row.id}>
                  ...
                  >
                    ...
                    {hasPermissionToEdit && (
                      <Link
                        className="inline-flex justify-center items-center w-9 h-9 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                        to={`/course-transaction/${row.id}/edit`}
...
export default CourseTransactionListTable;
