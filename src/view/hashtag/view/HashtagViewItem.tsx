...
function HashtagViewItem(props) {
  ...
  const displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record.hashtagText}</div>;
  };
...
HashtagViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
};

export default HashtagViewItem;
