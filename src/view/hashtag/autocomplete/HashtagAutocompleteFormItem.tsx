...
function HashtagAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return HashtagService.listAutocomplete(value, limit);
  };
  ...
  const mapper = {
    toAutocomplete(originalValue) {
      ...
      if (originalValue.hashtagText) {
        label = originalValue.hashtagText;
      }
...
export default HashtagAutocompleteFormItem;
