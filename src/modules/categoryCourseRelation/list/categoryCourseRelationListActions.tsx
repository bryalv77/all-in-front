...
const categoryCourseRelationListActions = {
  ...
  doClearAllSelected() {
    return {
      type: categoryCourseRelationListActions.CLEAR_ALL_SELECTED,
    };
  },

  doToggleAllSelected() {
    return {
      type: categoryCourseRelationListActions.TOGGLE_ALL_SELECTED,
    };
  },

  doToggleOneSelected(id) {
    return {
      type: categoryCourseRelationListActions.TOGGLE_ONE_SELECTED,
      payload: id,
    };
  },
  ...
  doReset: () => async (dispatch) => {
    dispatch({
      type: categoryCourseRelationListActions.RESETED,
    });

    dispatch(categoryCourseRelationListActions.doFetch());
  },
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      dispatch({
        type: categoryCourseRelationListActions.EXPORT_STARTED,
      });
      ...
      dispatch({
        type: categoryCourseRelationListActions.EXPORT_SUCCESS,
      });
    } catch (error) {
      Errors.handle(error);

      dispatch({
        type: categoryCourseRelationListActions.EXPORT_ERROR,
      });
    }
  },
  ...
  doChangeSort: (sorter) => async (dispatch, getState) => {
    dispatch({
      type: categoryCourseRelationListActions.SORTER_CHANGED,
      payload: sorter,
    });
