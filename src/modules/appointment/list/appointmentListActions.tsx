...
import exporterFields from '../../../modules/appointment/list/appointmentListExporterFields';
...
const appointmentListActions = {
  ...
  doChangePagination:
    (pagination) => async (dispatch, getState) => {
      ...
      dispatch(
        appointmentListActions.doFetchCurrentFilter(),
      );
    },
  ...
  doFetchCurrentFilter:
    () => async (dispatch, getState) => {
      ...
      dispatch(
        appointmentListActions.doFetch(
          filter,
          rawFilter,
          true,
        ),
