...
import exporterFields from '../../../modules/promotions/list/promotionsListExporterFields';
...
const promotionsListActions = {
  ...
  doChangePagination:
    (pagination) => async (dispatch, getState) => {
      ...
      dispatch(
        promotionsListActions.doFetchCurrentFilter(),
      );
    },
