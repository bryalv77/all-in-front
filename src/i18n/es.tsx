const es = {
  ...
  entities: {
    ...
    courseTransaction: {
        ...
        destroyAll: {
          success: 'Course Transaction(s) eliminado con éxito',
        },
        edit: {
    ...
    categoryCourseRelation: {
        ...
        exporterFileName: 'exportacion_categoryCourseRelation',
        list: {
          menu: 'Category Course Relations',
          title: 'Category Course Relations',
        },
        create: {
          success: 'Category Course Relation guardado con éxito',
        },
        update: {
          success: 'Category Course Relation guardado con éxito',
        },
        destroy: {
          success: 'Category Course Relation eliminado con éxito',
        },
        destroyAll: {
          success: 'Category Course Relation(s) eliminado con éxito',
        },
        edit: {
    ...
    conversationParticipant: {
        ...
        exporterFileName: 'exportacion_conversationParticipant',
        list: {
          menu: 'Conversation Participants',
          title: 'Conversation Participants',
        },
        create: {
          success: 'Conversation Participant guardado con éxito',
        },
        update: {
          success: 'Conversation Participant guardado con éxito',
        },
        destroy: {
          success: 'Conversation Participant eliminado con éxito',
        },
        destroyAll: {
          success: 'Conversation Participant(s) eliminado con éxito',
        },
        edit: {
    ...
    availabilityTimeslot: {
        ...
        destroy: {
          success: 'Availability Timeslot eliminado con éxito',
        },
        destroyAll: {
          success: 'Availability Timeslot(s) eliminado con éxito',
        },
        edit: {
