const en = {
  ...
  entities: {
    ...
    courseEnrollment: {
      ...
      destroyAll: {
        success:
          'Course Enrollment(s) successfully deleted',
      },
      edit: {
    ...
    courseTransaction: {
      ...
      destroyAll: {
        success:
          'Course Transaction(s) successfully deleted',
      },
      edit: {
    ...
    categoryCourseRelation: {
      ...
      create: {
        success:
          'Category Course Relation successfully saved',
      },
      update: {
        success:
          'Category Course Relation successfully saved',
      ...
      destroy: {
        success:
          'Category Course Relation successfully deleted',
      },
      destroyAll: {
        success:
          'Category Course Relation(s) successfully deleted',
      },
      edit: {
    ...
    conversationParticipant: {
      ...
      create: {
        success:
          'Conversation Participant successfully saved',
      },
      update: {
        success:
          'Conversation Participant successfully saved',
      ...
      destroy: {
        success:
          'Conversation Participant successfully deleted',
      },
      destroyAll: {
        success:
          'Conversation Participant(s) successfully deleted',
      },
      edit: {
    ...
    businessCategory: {
      ...
      destroyAll: {
        success:
          'Business Category(s) successfully deleted',
      },
      edit: {
    ...
    availabilityTimeslot: {
      ...
      destroy: {
        success:
          'Availability Timeslot successfully deleted',
      },
      destroyAll: {
        success:
          'Availability Timeslot(s) successfully deleted',
      },
      edit: {
