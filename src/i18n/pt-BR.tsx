const ptBR = {
  ...
  entities: {
    ...
    courseEnrollment: {
      ...
      destroyAll: {
        success:
          'Course Enrollment(s) deletado com sucesso',
      },
      edit: {
    ...
    courseTransaction: {
      ...
      destroyAll: {
        success:
          'Course Transaction(s) deletado com sucesso',
      },
      edit: {
    ...
    categoryCourseRelation: {
      ...
      exporterFileName:
        'Category Course Relation_exportados',
      list: {
        menu: 'Category Course Relations',
      ...
      create: {
        success:
          'Category Course Relation salvo com sucesso',
      },
      update: {
        success:
          'Category Course Relation salvo com sucesso',
      ...
      destroy: {
        success:
          'Category Course Relation deletado com sucesso',
      },
      destroyAll: {
        success:
          'Category Course Relation(s) deletado com sucesso',
      },
      edit: {
      ...
      importer: {
        ...
        fileName:
          'categoryCourseRelation_template_importacao',
        hint: 'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
      },
    },
    ...
    conversationParticipant: {
      ...
      exporterFileName:
        'Conversation Participant_exportados',
      list: {
        menu: 'Conversation Participants',
      ...
      create: {
        success:
          'Conversation Participant salvo com sucesso',
      },
      update: {
        success:
          'Conversation Participant salvo com sucesso',
      ...
      destroy: {
        success:
          'Conversation Participant deletado com sucesso',
      },
      destroyAll: {
        success:
          'Conversation Participant(s) deletado com sucesso',
      },
      edit: {
      ...
      importer: {
        ...
        fileName:
          'conversationParticipant_template_importacao',
        hint: 'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
      },
    },
    ...
    businessCategory: {
      ...
      destroyAll: {
        success:
          'Business Category(s) deletado com sucesso',
      },
      edit: {
    ...
    availabilityTimeslot: {
      ...
      destroy: {
        success:
          'Availability Timeslot deletado com sucesso',
      },
      destroyAll: {
        success:
          'Availability Timeslot(s) deletado com sucesso',
      },
      edit: {
      ...
      importer: {
        ...
        fileName:
          'availabilityTimeslot_template_importacao',
        hint: 'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
      },
    },
